<template>
  <view class="cf-page">
      ...
      <scroll-view scroll-x class="venue-bar__scroll">
        <view class="venue-chips">
          <view
            ...
            @click="filterVenueId = ''; page = 1; load()"
          >
          ...
          <view
            ...
            @click="filterVenueId = v.id; page = 1; load()"
          >
      ...
      >
        <view class="booking-card__top">
          <view class="booking-card__info">
            ...
            <text v-if="!filterVenueId" class="booking-card__venue">{{ r.venue_name }}</text>
          </view>
    ...
    <CfTabBar current="pages/bookings/index" />
  </view>
</template>
...
.page-header {
  ...
  &__title { font-size: 34rpx; font-weight: 700; color: $cf-white; }
}
...
.content {
  ...
  height: calc(100vh - 420rpx - env(safe-area-inset-top) - 100rpx);
}
